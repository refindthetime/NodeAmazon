...
var addNewProduct = function(){
	...
	var newProduct = {
		properties: {
			newIdNum:{ description:('Please enter a unique 5 digit item Id #')},
			newItemName:{ description:('Please enter the name of the product you wish to add')},
			newItemDepartment: { description: ('What department does this item belong in?')},
			newItemPrice: { description: ('Please enter the price of the item in the format of 00.00')},
